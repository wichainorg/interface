...
const sttaddr = "0x6033745cbb6d5a9a2c11a1ce167cd5f765b01c10";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x6033745cbb6d5a9a2c11a1ce167cd5f765b01c10";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://wichain.org?ref=' + document.getElementById('refaddress').value;
        }
    }
}
